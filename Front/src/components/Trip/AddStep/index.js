...
const AddStep = ({
    ...
    const locateSuggestion = () => {
      const adressSelected = suggestions.find((suggestion) => suggestion.label == localisationInput) || suggestions[0];
    ...
    return ( <
        ...
        {
          connectedUserId == trip.author[0].id && ( <
            div className = "add-step-container" > < Button onClick = {
              handleShow
            }
        ...
        <
        Modal.Title > Ajouter une étape <
        /Modal.Title> <
        /Modal.Header> <Modal.Body> <
        Form className = "form-add-step"
        onSubmit = {
...

{
  showInput && ( <
      InputGroup >
      <
      Form.Control name = "localisationInput"
      type = "text"
      defaultValue = {
        localisationInput
      }
